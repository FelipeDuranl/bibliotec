...
<body>
  ...
  <section>
    ...
    $resultado = mysqli_query($conexao, "SELECT f.nome, f.email, l.nomelivro, o.statusordem, o.statusdata, o.dataemprestimo, o.datadevolucao FROM livros AS l INNER JOIN funcionarios as f INNER JOIN ordens_funcionarios AS o ON (f.codfuncionario = o.codfuncionario AND l.codlivro = o.codlivro AND f.email = '$email')");
    ?>
