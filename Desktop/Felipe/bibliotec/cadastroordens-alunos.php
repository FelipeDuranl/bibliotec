...
<body>
  ...
  <section id="secdeletar"> 
    <div>
      ...
      <hr class="my-1">
      <h2 class="atividades">Crie ordens de aluguel para alunos</h2>
      <hr class="my-4">
  ...
  <!-- FORMULÁRIO DE UPDATE DE ORDENS DE ALUNOS -->
  ...
  <section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          <form action="insertordens-alunos.php" method="POST">
            ...
            <div class="row">
              ...
              <div class="col">
                <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Aluno</label>
