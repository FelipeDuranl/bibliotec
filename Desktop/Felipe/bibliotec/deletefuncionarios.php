...
<body>
  ...
  <section id="secdeletar"> 
    <div>
      ...
      <hr class="my-1">
      <h2 class="atividades">Ver e deletar cadastros dos funcionários</h2>
      <hr class="my-4">
        ...
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            while($dados = mysqli_fetch_assoc($resultado)) {
              ...
              <form method="POST" action="apagafuncionarios.php">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td></td>
                    <!--<td><button type="Submit" value="<?php echo $dados['codfuncionario'] ?>" class="btn btn-warning btn-block butn-deletar" name="codigofunc">Deletar</button></td> -->
                    <td>
                      <?php
                        echo '
                        ...
                        <button type="button" class="btn btn-warning btn-block butn-deletar" data-toggle="modal" data-target="#modalDeletar'.$dados['codfuncionario'].'">
                            Deletar
                        </button>
                        ...
                        <div class="modal fade" id="modalDeletar'.$dados['codfuncionario'].'" tabindex="-1" role="dialog" aria-labelledby="ModalDelete" aria-hidden="true">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                        Tem certeza que deseja deletar o registro do funcionário: '. $dados['nome'].'?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">
                                              Fechar
                                        </button>
                                        <button type="Submit" name = "codigofunc" class="btn btn-primary" value="'.$dados['codfuncionario'].'">
                                          Deletar
                                        </button>
                                    </div>
                                </div>
