...
<body>
  ...
  <section id="secdeletar"> 
    <div>
      ...
      <hr class="my-1">
      <h2 class="atividades">Atualize as informações das ordens de aluguel de alunos</h2>
      <hr class="my-4">
  ...
  $resultado = mysqli_query($conexao, "SELECT a.")
  ...
  <section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          <form action="atualizaordens-alunos.php" method="POST">


            <!-- CÓDIGO PHP PARA AS CONSULTAS -->
            <?php

            $resultado = mysqli_query($conexao, "SELECT codaluno, rm, nomealuno  FROM alunos");
            ...
            <div class="row">
              ...
              <div class="col">
                <label class="my-1 mr-2">Aluno</label>
                <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="codigoaluno">
                  <option selected hidden>...</option>

                  <?php while($dados = mysqli_fetch_assoc($resultado)) { ?>


                    <option value="<?php echo $dados['codaluno']; ?>"><?php echo $dados['rm'] . " - " . $dados['nomealuno']; ?></option>
                ...
                <small class="form-text text-muted" >Escolha o aluno que irá fazer o aluguel do livro.</small>
              </div>
              ...
              <div class="col">
                ...
                <small class="form-text text-muted" >Escolha o livro que o aluno irá alugar.</small>
              </div>
            ...
            <div class="row">
              ...
              <div class="col">
                ...
                <small class="form-text text-muted" >Digite a data em que o aluno fez o aluguel do livro.</small>
              </div>

              <div class="col">
                <label>Data da devolução</label>
                <input type="text" class="form-control" name="datadevo" placeholder="Ex: 10/11/2019">
                <small class="form-text text-muted" >Digite a data em que o aluno deverá fazer a devolução do livro.</small>
              </div>
