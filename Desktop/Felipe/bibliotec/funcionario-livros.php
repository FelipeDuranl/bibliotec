...
<body>
  ...
  <section id="secatividades"> 
    <div>
      ...
      <hr class="my-1">
      <h2 class="atividades">Veja os livros disponíveis da biblioteca</h2>
      <hr class="my-4">
  ...
  <section>
    ...
    $resultado = mysqli_query($conexao, "SELECT nomelivro, autor, editora, data ,qtde_livro FROM livros")
