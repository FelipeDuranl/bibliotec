...
<body>
  ...
  <section id="secdeletar"> 
    <div>
      ...
      <hr class="my-1">
      <h2 class="atividades">Atualize as informações do livro</h2>
      <hr class="my-4">
  ...
  <section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          <form action="atualizalivros.php" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <small class="form-text text-muted">Código do livro.</small>
              </div>
