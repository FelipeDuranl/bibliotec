  ...
  <body>
    ...
    <section id="secdeletar"> 
      <div>
                  ...
                  <hr class="my-1">
                  <h2 class="atividades">Ver e deletar cadastros dos alunos</h2>
                  <hr class="my-4">
          ...
          <div class="table-responsive">
            <table class="table table-hover">
              ...
              while($dados = mysqli_fetch_assoc($resultado)) {
                ...
                <form method="POST" action="apagaalunos.php">
                  <tbody>

                    <tr>
                      <th scope="row"><?php echo $dados['codaluno'] . "<br>"; ?></th>
                      ...
                      <?php
                        ...
                        <button type="button" class="btn btn-warning btn-block butn-deletar" data-toggle="modal" data-target="#modalDeletar'.$dados['codaluno'].'">
                            Deletar
                        </button>
                        ...
                        <div class="modal fade" id="modalDeletar'.$dados['codaluno'].'" tabindex="-1" role="dialog" aria-labelledby="ModalDelete" aria-hidden="true">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                        Tem certeza que deseja deletar o registro do aluno: '. $dados['nomealuno'].'?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">
                                              Fechar
                                        </button>
                                        <button type="Submit" name = "codigo" class="btn btn-primary" value="'.$dados['codaluno'].'">
                                          Deletar
                                        </button>
                                    </div>
                                </div>
