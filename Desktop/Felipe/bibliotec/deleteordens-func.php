...
<body>
  ...
  <section id="secdeletar"> 
    <div>
      ...
      <hr class="my-1">
      <h2 class="atividades">Ver e deletar as ordens de aluguel dos funcionários</h2>
      <hr class="my-4">
  ...
  $resultado = mysqli_query($conexao, "SELECT o.codordem_func, o.statusordem, o.statusdata, f.codfuncionario, f.nome, f.telefone, l.nomelivro, o.dataemprestimo, o.datadevolucao FROM ordens_funcionarios AS o INNER JOIN funcionarios AS f INNER JOIN livros AS l ON (o.codfuncionario = f.codfuncionario AND o.codlivro = l.codlivro)");
        ...
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            while($dados = mysqli_fetch_assoc($resultado)) {
              ...
              <form method="POST" action="apagaordens-func.php">
                <tbody>

                  <tr>
                    <th scope="row"><?php echo $dados['codordem_func'] . "<br>"; ?></th>
                    <td><?php echo $dados['codfuncionario'] . "<br>"; ?></td>
                    ...
                    <td>
                      <?php
                        ...
                        <button type="button" class="btn btn-warning btn-block butn-deletar" data-toggle="modal" data-target="#modalDeletar'.$dados['codordem_func'].'">
                            Deletar
                        </button>
                        ...
                        <div class="modal fade" id="modalDeletar'.$dados['codordem_func'].'" tabindex="-1" role="dialog" aria-labelledby="ModalDelete" aria-hidden="true">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                        Tem certeza que deseja deletar o registro de ordem do funcionário: '. $dados['nome'].' e do livro: ' . $dados['nomelivro'].'?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">
                                              Fechar
                                        </button>
                                        <button type="Submit" name = "codordfunc" class="btn btn-primary" value="'.$dados['codordem_func'].'">
                                          Deletar
                                        </button>
                                    </div>
                                </div>
